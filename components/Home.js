...
class Home extends Component {
    ...
    render() {
        ...
        //     console.log("render table this.state.repos = ", this.state.repos);
        //     RepoTable = (
        //         <ReactTable data={this.state.repos}
        //             noDataComponent={() => <div>No data to display</div>}
        //             columns={columns}/>
        //             )
        // }
            ...
            userInfo = (
                <div className='userInfo'>
                    <div className='basicInfo'>
                        <div id="repoNo" className='smallTile'><div className='boldNumber'>{this.state.data.public_repos}</div> Repos</div>
                        <div id="followerNo" className='smallTile'><div className='boldNumber'>{this.state.data.followers}</div> Followers</div>
                        <div id="followers" className='smallTile'><div className='boldNumber'>{this.state.data.following}</div> Following</div>
                        <div id="gists" className='smallTile'><div className='boldNumber'>{this.state.data.public_gists}</div> Gists</div>
                    </div>
                    ...
                    <div className='userTile'>
                        ...
                        <div className='userDetail'>
                            ...
                            <div className='email'>Company: {this.state.data.company}</div>
                            <div className='email'>Location: {this.state.data.location}</div>
